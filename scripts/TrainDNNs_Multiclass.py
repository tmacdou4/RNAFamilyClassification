...
parser.add_argument('-epochs',dest = 'EPOCHS', default = 500 , type = int, help = 'nb of max epochs')
...
for taskID in TASKS: 
        ...
        for ARCH  in ARCHs:
            ...
            for foldn in range(1 , args.XVAL + 1):
                ...
                print('(MultiClass) TASK {} ARCH {} MODEL {} fold {} / {}'.format(taskID, ARCH, modelID, foldn, args.XVAL))
                ...
                outFile.write("## test yscores:" + ",".join([str(score) for score in out.detach().cpu().numpy()]) + "\n")
